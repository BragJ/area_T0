...
xmllint ${ATTRIBUTE_SCHEMA} ../../ADnED/example/iocBoot/iocexample/ADDetectorAttributes.xml
...
xmllint ${HDF5_TEMPLATE_SCHEMA} ../../ADnED/example/iocBoot/iocexample/ADhdf5_layout.xml