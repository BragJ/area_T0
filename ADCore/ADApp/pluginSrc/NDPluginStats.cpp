...
asynStatus NDPluginStats::doComputeHistogramT(NDArray *pArray)
{
    ...
    ////std::cout << "it's my soul0:::"<<std::endl; 
    this->unlock();
...
void NDPluginStats::doComputeStatisticsT(NDArray *pArray, NDStats_t *pStats)
{
    ...
    pStats->total = 0.;
    pStats->sigma = 0.;
    ////std::cout << "it's my soul1:::"<<std::endl; 
...
{
    //std::cout << "it's my soul2:::"<<std::endl; 
    epicsType *pData = (epicsType *)pArray->pData;
...
{
    //std::cout << "it's my soul:::3"<<std::endl; 
    epicsType *pData = (epicsType *)pArray->pData;
...
void NDPluginStats::processCallbacks(NDArray *pArray)
{
     ...
     */
    //std::cout << "it's my soul:::4"<<std::endl; 
...
{
    //std::cout << "it's my soul:::5"<<std::endl; 
...
{
    //std::cout << "it's my soul:::6"<<std::endl; 
    int function = pasynUser->reason;
    asynStatus status = asynSuccess;
...
{
    //std::cout << "it's my soul:::7"<<std::endl; 
