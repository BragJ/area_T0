...
/* Generated from ../O.Common/simDetectorApp.dbd */
...
int simDetectorApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/opt/egcs/epics/modules/areaDetector/ADExample/iocs/simDetectorIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"simDetectorApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    simDetectorApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
