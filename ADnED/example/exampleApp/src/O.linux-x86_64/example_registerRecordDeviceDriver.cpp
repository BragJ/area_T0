...
epicsShareExtern void (*pvar_func_ADnEDRegister)(void);
epicsShareExtern void (*pvar_func_ADnEDPixelROIRegister)(void);
epicsShareExtern void (*pvar_func_NDMaskRegister)(void);
epicsShareExtern void (*pvar_func_ADnEDAxis)(void);
...
{
    const char *bldTop = "/opt/egcs/epics/modules/areaDetector/ADnED/example";
    ...
    (*pvar_func_ADnEDRegister)();
    (*pvar_func_ADnEDPixelROIRegister)();
    (*pvar_func_NDMaskRegister)();
    (*pvar_func_ADnEDAxis)();
