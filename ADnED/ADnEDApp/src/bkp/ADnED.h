...
class ADnED : public ADDriver {
 ...
 public:
  ...
  //file or group name
  char single_hdf_file_name[100];
  char capture_tof_name[100],capture_pixel_name[100];
  char stream_tof_name[100],stream_pixel_name[100];
  
  // const param
  const int  pulse_num_per_file = 10;
  
  // nexus file write param
  int pulse_id_dim; 
  NXhandle file_id;
  NXhandle capture_file_id;
  //capture_clone_fileid; stream_clone_fileid
  NXhandle stream_file_id;
  NXstatus nxstat;
  

  // meta data
  int GEM_gas_len,GEM_HV1_len,GEM_HV2_len;
  char* GEM_gas = "90%Co2:10%Ne"; 
  char* GEM_HV_1= "-400V";
  char* GEM_HV_2= "-1400V";
