...
void ADnED::eventHandler(shared_ptr<epics::pvData::PVStructure> const &pv_struct, epicsUInt32 channelID)
{
  ...
  cout << "the chargeData is ::" << mT0 <<endl;
  if (!pChargePtr) {
    if (eventUpdate) {
  ...
  if (pixelsPtr && tofPtr) {
    ...
    switch(hdfFileWriteMode){
      ...
      case 1:
        ...
        NXmakedata (capture_file_id, "T0_PusleID_EventNum", NX_UINT64, 1, unlimited_dims);
        ...
        NXclosedata (capture_file_id); 
            ...
            NXopenpath (capture_file_id,"/entry/data");
            NXopendata (capture_file_id, "T0_PusleID_EventNum");
            slab_start[0] = capture_group_num%pulse_num_per_file*3; slab_size[0] = 3;
            //cout << slab_start[0] << "      "  << slab_size[0] << endl;
      ...
      //  cout<< "I'm running::: " << stream_group_num <<endl;
        ...
        { 
          ...
          NXmakedata (stream_file_id, "T0_PusleID_EventNum", NX_UINT64, 1, unlimited_dims);
        ...
        NXopenpath (stream_file_id,"/entry/data");
        NXopendata (stream_file_id, "T0_PusleID_EventNum");
        slab_start[0] = stream_group_num*3; slab_size[0] = 3;
        //cout << slab_start[0] << "      "  << slab_size[0] << endl;
