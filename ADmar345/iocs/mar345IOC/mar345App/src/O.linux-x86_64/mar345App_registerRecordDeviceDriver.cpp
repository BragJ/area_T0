...
/* Generated from ../O.Common/mar345App.dbd */
...
static const char * const deviceSupportNames[94] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[94] = {
...
epicsShareExtern void (*pvar_func_mar345Register)(void);
...
epicsShareExtern void (*pvar_func_NDROIStatRegister)(void);
...
epicsShareExtern void (*pvar_func_register_func_myTimeStampSource)(void);
epicsShareExtern void (*pvar_func_register_func_myAttrFunct1)(void);
...
int mar345App_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/opt/egcs/epics/modules/areaDetector/ADmar345/iocs/mar345IOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"mar345App_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    mar345App_registerRecordDeviceDriver(*iocshPpdbbase);
}
